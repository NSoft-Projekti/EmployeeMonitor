...
<div class="regrm">
Radno mjesto:  <select name="position" class="textfields" id="position">
 ...
 //if(strlen($query) >= $min_length){ 
	...
	{ 
			...
			
		{
			...
			{
				  		echo "<form action='functions/deleteZaposlenikById.php' method ='GET'>";
		 		...
		 		echo "<td>" .htmlspecialchars($results['RegistrationDate']) . "</td>";
